              ...
              <TabsContent value="discover" className="space-y-4 mt-6">
                <Card className="border-pink-500/20 overflow-hidden">
                  <CardHeader className="bg-gradient-to-r from-blue-500/10 to-pink-500/10">
                    ...
                    <CardDescription>Explore topics popular in your university</CardDescription>
                  </CardHeader>
                ...
                <Card className="border-pink-500/20 overflow-hidden">
                  <CardHeader className="bg-gradient-to-r from-yellow-400/10 to-blue-500/10">
                    ...
                    <CardDescription>Hot topics on campus right now</CardDescription>
                  </CardHeader>
                  <CardContent className="space-y-4 pt-6">
                    <div className="flex items-start gap-4">
                      ...
                      <div>
                        <h4 className="text-sm font-medium">AI Ethics in Research</h4>
                        <p className="text-sm text-muted-foreground">32 students discussing</p>
                      </div>
                    </div>
                    ...
                    <div className="flex items-start gap-4">
                      ...
                      <div>
                        <h4 className="text-sm font-medium">Sustainable Campus Initiatives</h4>
                        <p className="text-sm text-muted-foreground">24 students discussing</p>
                      </div>
                    </div>
                    ...
                    <div className="flex items-start gap-4">
                      ...
                      <div>
                        <h4 className="text-sm font-medium">Remote Learning Effectiveness</h4>
                        <p className="text-sm text-muted-foreground">18 students discussing</p>
                      </div>
                    </div>
                  </CardContent>
                </Card>
