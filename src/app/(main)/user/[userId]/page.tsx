               ...
               <div className='relative z-10 py-12 px-6 md:px-12 flex flex-col md:flex-row items-center gap-6 md:gap-12'>
                  ...
                  <div className='text-center md:text-left'>
                     ...
                     <p className='text-muted-foreground mb-4'>
                        {user.userDetails?.department}, Year{" "}
                     ...
                     <div className='flex flex-wrap justify-center md:justify-start gap-2'>
                        <CoffeeChatInviteModal
                           user={{
                              ...
                              department: user.userDetails
                                 ?.department as string,
                              interests: commonInterests.map(
                                 (interest) => interest.interestName
                              ),
                              currentUserId: thisUser.userDetails?.id as string,
                           }}
                           sharedInterests={commonInterests.map(
                              (interest) => interest.interestName
                           )}
                        >
                        ...
                        <SendMessageButton
                           thisUserId={thisUser.userDetails?.id as string}
               ...
               <div className='space-y-6'>
                  ...
                  <Tabs defaultValue='about' className='w-full'>
                        ...
                        <Card className='border-pink-500/20'>
                           ...
                           <CardContent className='pt-6'>
                              <div className='flex flex-wrap gap-2'>
                                 {user.userDetails?.interests.map((interest, index) => {
                                    const colors = [
                     ...
                     <TabsContent value='posts' className='space-y-4 mt-6'>
                        {user.userDetails?.posts && user.userDetails?.posts.length > 0 ? (
                           user.userDetails?.posts.map((post) => (
                              <InterestPost
                                 key={post.id}
                                 postId={post.id}
                                 userId={user.userDetails?.id as string}
                     ...
                     <TabsContent value='events' className='space-y-4 mt-6'>
                        <Card className='border-pink-500/20'>
                           ...
                           <CardContent className='pt-6'>
                              {user.userDetails?.asEventOrganizer &&
                              user.userDetails?.asEventOrganizer.length > 0 ? (
                                 <div className='space-y-4'>
                                    {user.userDetails?.asEventOrganizer.map(
                                       (event) => (
                                          <div
                                             key={event.id}
                                             className='rounded-lg border border-pink-500/20 p-4'
                                          >
               ...
               <div className='space-y-6'>
                        ...
                        <div className='flex gap-4'>
                           ...
                           <div>
                              <p className='font-medium'>
                                 {user.userDetails?.reading?.split(" by ")[0] ||
                                    "No reading"}
                              </p>
                              {user.userDetails?.reading?.split(" by ")[1] ? (
                                 <p className='text-sm text-muted-foreground'>
                                    by{" "}
                                    {
                                       user.userDetails?.reading?.split(
                                          " by "
                                       )[1]
                                    }
                                 </p>
                  ...
                  <Card className='border-pink-500/20 overflow-hidden'>
                     ...
                     <CardContent className='pt-6'>
                        ...
                        <p className='text-sm text-muted-foreground'>
                           Connected with Alex Johnson, Morgan Lee, and Casey
                           Wong
                        </p>
                        <p className='text-sm text-muted-foreground'>
                           (Incoming feature)
