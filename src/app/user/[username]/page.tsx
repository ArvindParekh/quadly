...
import { BookOpen, Calendar, Coffee, MessageSquare, Share, Sparkles, Users } from "lucide-react"
...
export default function UserProfilePage({ params }: UserProfileProps) {
  ...
  const userColor = getColorFromUsername(user.username)
            ...
            <Tabs defaultValue="about" className="w-full">
              ...
              <TabsContent value="about" className="space-y-6 mt-6">
                ...
                <Card className="border-pink-500/20">
                  ...
                  <CardContent className="pt-6">
                    <div className="flex flex-wrap gap-2">
                      {user.connectionPreferences.map((preference, index) => {
                        const colors = [
                          "bg-pink-500/10 text-pink-500 border-pink-500/20",
                          "bg-yellow-400/10 text-yellow-400 border-yellow-400/20",
                          "bg-blue-500/10 text-blue-500 border-blue-500/20",
            ...
            <Card className="border-pink-500/20 overflow-hidden">
              ...
              <CardContent className="pt-6">
                <div className="flex gap-4">
                  ...
                  <div>
                    <p className="font-medium">{user.currentlyReading.split(" by ")[0]}</p>
                    <p className="text-sm text-muted-foreground">by {user.currentlyReading.split(" by ")[1]}</p>
                  </div>
                </div>
              </CardContent>
            </Card>
